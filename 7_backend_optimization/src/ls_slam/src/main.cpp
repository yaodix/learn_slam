...
int main(int argc, char **argv)
{
    ...
    std::string VertexPath = "/home/yao/workspace/learn_slam/7_backend_optimization/src/ls_slam/data/test_quadrat-v.dat";
    std::string EdgePath = "/home/yao/workspace/learn_slam/7_backend_optimization/src/ls_slam/data/test_quadrat-e.dat";

//    std::string VertexPath = "/home/yao/workspace/learn_slam/7_backend_optimization/src/ls_slam/data/intel-v.dat";
//    std::string EdgePath = "/home/yao/workspace/learn_slam/7_backend_optimization/src/ls_slam/data/intel-e.dat";
